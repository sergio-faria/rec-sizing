...
from rec_sizing.optimization.structures.I_O_collective_pool_milp_ewh import (
	INPUTS_POOL_EWH,
	OUTPUTS_POOL_EWH
)
...
def test_solve_collective_pool_milp_ewh():
	...
	for ki, valu in results.items():
		assert valu == OUTPUTS_POOL_EWH.get(ki), f'{ki}'


if __name__ == '__main__':
	test_solve_collective_pool_milp_ewh()
