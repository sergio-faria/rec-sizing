...
from rec_sizing.custom_types.optimization_helpers_types import (
    MetersDict,
    MetersParamDict
)
from typing import Union, List, Dict  # ✅ Use typing generics for 3.8
...
def dict_per_param(meters: MetersDict, values_id: str) -> MetersParamDict:
    """
    Returns a dictionary with the Meters' IDs as keys and the specified objects of data as values.
    :param meters: data from all Meters
    :param values_id: param key from "meters"
    :return: dictionary whose keys are Meter IDs and the values are the specified objects in values_id
    """
